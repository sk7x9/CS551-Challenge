...
namespace challenge
{
    public partial class supermarkets : System.Web.UI.Page
    {
        ...
        {
            string UrlRequest = "http://www.SupermarketAPI.com/api.asmx/COMMERCIAL_SearchByProductName?APIKEY=0295cbc332&ItemName=" + queryString;
            return (UrlRequest);
